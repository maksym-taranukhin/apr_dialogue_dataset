...
from examples.model_chat.bot_agent import TurkLikeAgent
from examples.model_chat.utils import get_context_generator
...
class ModelChatBlueprint(BaseModelChatBlueprint):
    ...
    def _get_shared_models(self, args: "DictConfig") -> Dict[str, dict]:
        all_model_opts = OmegaConf.load(args.blueprint.model_opt_path)
        active_model_opts = {
            model: opt
